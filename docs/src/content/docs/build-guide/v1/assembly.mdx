...
1. XIAO カバー部分の残りの穴を M2 9mm のねじ（短い方） 2本とナイロンワッシャーでねじ止めします。
...
1. 右側のトップケースに回路基板を入れます。こちらも真っ直ぐ入れると LED 部分が干渉するので少し斜めから入れます。入れたら tadpone ピンをトップケースの穴にしっかりと合わせて奥まで押し込みます。
...
### 6.5 電池カバーの取り付け
    ...
    電池カバーは裏側から差し込むように取り付けます。カバーは最初は少し硬いですが、何度か取り付けるうちに少し柔らかくなってきます。
    カバーはロックされたような状態になっており、カバーの上の部分を押さえつけながら指の腹で少しスライドすると外れるような設計になっています。爪を使って無理に引っ張ると爪が割れる可能性があるのでお気をつけください。
